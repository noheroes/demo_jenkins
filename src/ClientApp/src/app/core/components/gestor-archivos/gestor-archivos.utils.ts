import { IGestorArchivosConfig, IGAInternalDisplayConfig, IGestorArchivosFriendlyConfig } from './gestor-archivos.interface';
...
export const GaUtils = {
  ...
  encriptionDetectionTokensDictionary: [
    { filetype: 'pdf', signature: '2F456E6372797074' }],
  ...
  validarArchivoParaSubir: (file: any, pesoMaximoMb: number, tiposPermitidos: string[] | string): Promise<void> => {
